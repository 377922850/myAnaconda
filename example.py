...
test_x = mnist.test.images[:500]
test_y = mnist.test.labels[:500]
...
def plot_with_labels(lowDWeights, labels):
    ...
    plt.xlim(X.min(), X.max()); plt.ylim(Y.min(), Y.max()); plt.title('Visualize last layer');plt.pause(0.01);plt.show()
